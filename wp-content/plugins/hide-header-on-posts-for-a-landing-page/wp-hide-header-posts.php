...
/*
  ...
  Plugin URI: https://wppagetemplates.com?utm_source=wp-admin&utm_medium=plugins-list&utm_term=hider-header-posts
  Description: Hide header when viewing posts and convert posts to landing pages easily.
  Version: 1.0.3
  Author: GreenJayMedia
  Author URI:  https://greenjaymedia.com?utm_source=wp-admin&utm_medium=plugins-list&utm_term=hider-header-posts
